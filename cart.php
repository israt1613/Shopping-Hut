	...
	<div class="row">
		...
		<?php else: ?>
			<table class="table table-bordered table-condensed table-striped">
				<thead><th>#</th><th>Item</th><th>Price</th><th>Quantity</th><th>Size</th><th>Total Price</th></thead>
				<tbody>
					<?php
			...
			<table class="table table-bordered table-condensed text-right">
				...
				<thead class="totals-table-header"><th>Total Items</th><th>Total Price</th><th>Tax (<?php echo TAXRATE*100 ?>% per product)</th><th>Grand Total</th></thead>
				<tbody>
					<tr>
						<td><?=$item_count;?></td>
...
<script>
	...
	function check_address(){
		...
		jQuery.ajax({
				url : '/shoppingHut/admin/parsers/check_address.php',
		    method : 'POST',
		    data : data,
